...
- 在sqs测试curl -G "http://localhost:9601/bus/files/search_chunks"   --data-urlencode "key_words=防火墙策略"   --data-urlencode "kbase_names=3"   --data-urlencode "top_k=10"
- 当kbase_names=2的时候能输出东西，应该是说明现在用的文件系统对应的知识库就是kbase_id =2